...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA3     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = APPS1_Analog_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(APPS1_Analog_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PC0     ------> ADC2_IN10
    */
    GPIO_InitStruct.Pin = APPS_2_Analog_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(APPS_2_Analog_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Pressure_Transducer_1_Analog_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(APPS1_Analog_GPIO_Port, APPS1_Analog_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC0     ------> ADC2_IN10
    */
    HAL_GPIO_DeInit(APPS_2_Analog_GPIO_Port, APPS_2_Analog_Pin);
